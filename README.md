# Tp5 - DOM Y BOM
 ...
 En este repositorio se encuentra el ejercicio 2 resuelto del Tp5 - DOM Y BOM de JavaScript del instituto Rolling Code School
...
```sh
$ git clone https://github.com/santinohamada/Tp5-Ej2.git
```
